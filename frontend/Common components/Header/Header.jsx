        ...
        >
            <div className="header__inner">
                ...
                <nav className={`header__nav ${menuOpen ? 'header__nav--open' : ''}`}>
                    ...
                    <a href="https://t.me/hlorka_bot" target="_blank" rel="noopener noreferrer" className="header__phone" onClick={() => { setMenuOpen(false); trackContactClick('telegram'); }}>
                    ...
                    <a href="tel:+380800334267" className="header__phone" onClick={() => trackContactClick('phone')}>
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
